...
} from './sections/ProcessSection/ProcessSection';
import {
  TestimonialSectionDesktop,
  TestimonialSectionMobile,
} from './sections/TestimonialSection/TestimonialSection';
...
export const LandingPageDesktop = (): JSX.Element => {
  ...
  return (
    <div className="bg-[#fbfcfc] p-4 max-sm:p-0 flex flex-row justify-center w-full">
      <div className="bg-gray-25 w-full  relative">
        <Header onToggleDark={() => {}} onToggleDir={() => {}} />
        <div
          className="w-full h-[97vh] p-6 relative rounded-lg"
          style={{
