          ...
          <Grid container item direction="column" xs={9} spacing={2}>
              ...
              <Grid item md={3} xs={12}>
                ...
                <Grid item>
                  <div style={{ display: '-webkit-box' }}>
                    ...
                    <Typography>3787 Kingsway Street</Typography>
                  </div>
                </Grid>
              </Grid>
            ...
            <Grid item container direction="row">
              <Grid container item xs={7} spacing={3}>
                <Grid item>
                  <Typography>
                    Vancouver Memorial Services and Crematorium has provided
                    funeral, cremation and burial services in Vancouver, British
                    Columbia, for more than 100 years. Vancouver ksdjhbagkjsd
                    sdlkjhbvgskdljfsldf sdfb sdkjfbsdf suify sdkjfbsdf ksdfuyi
                    sdfkjsd fk
                  </Typography>
                </Grid>
              </Grid>
        ...
        <Grid container direction="row" spacing={2}>
          ...
          <Grid item>
            ...
            >
              ...
              more than 100 years. Vancouver ksdjhbagkjsd sdlkjhbvgskdljfsldf
              sdfb sdkjfbsdf suify sdkjfbsdf ksdfuyi sdfkjsd fk
            </Typography>
          </Grid>
